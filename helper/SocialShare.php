  ...
  public function __invoke(ItemRepresentation $item)
  {
    ...
    return '
        ...
        <ul id="social-share" class="list-inline mb-0 mt-2 fs-4">
          ...
          <li class="list-inline-item">
            <a class="link-dark" target="_blank" href="mailto:?body=' . $body . '&subject=' . $subject . '">
          ...
          <li class="list-inline-item">
            <a class="link-dark" target="_blank" href="https://www.facebook.com/share.php?u=' . $url . '">
          ...
          <li class="list-inline-item">
            <a class="link-dark" target="_blank" href="https://twitter.com/intent/tweet?url=' . $url . '">
